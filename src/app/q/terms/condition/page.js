    ...
    <div className={style.item}>
      ...
      {index === "7" ? (
        <p className={style.text}>
          {text} <a href="https://qviple.com">Qviple.com</a>
        </p>
      ) : (
        ...
        <div className={style.container}>
          <div className={style.content}>
            <div className={style.contentheader}>
              <div></div>
              <h5 className={style.heading}>Terms & Conditions</h5>
              <a href="/">
                <img src="/images/close-post-icon.svg" alt="close" />
              </a>
            </div>
            <Divider />
            ...
            <div className={style.contentbody}>
              <h5 className={style.heading}>
                Last Updated on :- 24 Nov, 2022 | 11:16 pm
              </h5>
              <h5 className={style.heading}>General Terms</h5>
              <p className={style.text}>
                By accessing and placing an order with Qviple, you confirm that
                ...
                communication between you and Qviple.
              </p>
              <p className={style.text}>
                ...
                site, even if Qviple team or an authorized representative has
              ...
              <p className={style.text}>
                Qviple will not be responsible for any outcome that may occur
                ...
                any moment. This Terms &amp; Conditions was created with
                <a href="https://termify.io" target="_blank" rel="noreferrer">
                  Termify
                </a>
                .
              </p>
              <h5 className={style.heading}>License</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                Qviple (referred to in these Terms &amp; Conditions as "Qviple",
                "us", "we" or "our"), the provider of the Qviple website and the
                services accessible from the Qviple website (which are
              ...
              <p className={style.text}>
                ...
                use the Qviple Service. In these Terms &amp; Conditions, "you"
          ...
          Qviple to use the Services."
              />
              <h5 className={style.heading}>Restrictions</h5>
              <p className={style.text}>
              ...
              <ul>
                <li className={style.text}>
                  ...
                  the app or make the platform available to any third party.
                </li>
                <li className={style.text}>
              ...
              <h5 className={style.heading}>Payment Refund Policy</h5>
              <p className={style.text}>
                1- One Should get refund within 48 hours of transactions done.
              </p>
              <p className={style.text}>
                2- Only non-institute payments can be refunded
              </p>
              <p className={style.text}>
                3- For institute related payments enquire with institute. [What
                are institute related payments: Payments made to institute such
                as ID Card fees, admission fees or any fees directly paid to
                institute]
              </p>
              <p className={style.text}>
                4- Non - Institute Payments include Application fees, Purchase
                of E-content, subscription fees.
              </p>
              <p className={style.text}>
                5- For Refund: "Type Refund" (Transaction Id) in support and we
                will get back to you within 24 hours.
              </p>
              <h5 className={style.heading}>Return and Refund Policy</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                that apply to transactions at Qviple. We'll be as brief as our
                attorneys will allow. The main thing to remember is that by
                placing an order or making a purchase at Qviple, you agree to
                the terms along with Qviple's Privacy Policy.
              </p>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Your Suggestions</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                site and how it's being used. By using our app, registering an
                account, or making a purchase, you hereby consent to our Terms
                &amp; Conditions.
              </p>
              <h5 className={style.heading}>Your commitment</h5>
              <p className={style.text}>
                In return for our commitment to providing services, we require
                you to be committed to the following:
              </p>
              <h5 className={style.heading}>Who can use Qviple?</h5>
              <p className={style.text}>
                We want our service to be as free and comprehensive as possible
                but we also want it to be safe, protected and law abiding. So,
                we need you to follow some restrictions to be part of the Qviple
                community.
              </p>
              <ul>
                <li className={style.text}>
                  You must be at least 13 years old to use Qviple Independently,
                  or at least the legal age applicable in your country.
                </li>
                <li className={style.text}>
                  If you are 13 years old or below then your parents should
                  operate your account on your behalf or you can on your
                  parents's permission.
                </li>
                <li className={style.text}>
                  You should not be prohibited from receiving any part of our
                  Services under applicable laws or be involved in payment
                  related services if you are on the list of denied parties to
                  which you apply.
                </li>
                <li className={style.text}>
                  Your account violated the law or any of our policies so we
                  must not have previously disabled it.
                </li>
                <li className={style.text}>
                  You must not be convicted as a sex offender.
                </li>
              </ul>
              <h5 className={style.heading}>How can you not use Qviple</h5>
              <p className={style.text}>
                We need to do our part to provide a safe and free service to the
                wider community. You cannot impersonate or misrepresent others.
                You are not required to disclose your identity on Qviple but you
                are required to provide us with accurate and up-to-date
                information (including registration information), which may
                include providing your personal data. Also, you cannot
                impersonate another person or something that you are not, and
                you cannot create an account for them unless you have the
                express permission of another person.
              </p>
              <ul>
                <li className={style.text}>
                  You may not do anything illegal, misleading or deceptive or
                  for illegal or unauthorized purposes.
                </li>
                <li className={style.text}>
                  You especially: Qviple community guidelines, music as well as
                  between the guidelines, or conditions or in violation of our
                  policies, and (or cannot support or encourage) others to
                  violate.
                </li>
                <li className={style.text}>
                  If you post branded content, you must comply with related
                  branded compliance policies of your country or that company
                  which require you to use our branded content tool.
                </li>
                <li className={style.text}>
                  There is nothing you can do to interfere with the purpose of
                  the service or to disrupt its operation.
                </li>
                <li className={style.text}>
                  This includes the misuse of any reporting, dispute or appeal
                  channel, such as fraudulent or baseless reports or appeals.
                </li>
                <li className={style.text}>
                  You may not attempt to create or access accounts or collect
                  information in an unauthorized manner. This includes creating
                  accounts or collecting information by automated methods
                  without our explicit permission.
                  <p className={style.text}>
                    We may not sell, license or purchase or license any account
                    or data we receive from our Services.
                  </p>
                  This includes attempting to buy, sell or transfer any aspects
                  of your account (including username); Requesting, compiling,
                  or using other users' login credentials or badges; Or
                  requesting or compiling Qviple usernames, passwords, or
                  inappropriate access tokens.
                </li>
                <li className={style.text}>
                  You may not post anyone else's confidential or confidential
                  information without permission or act in a way that infringes
                  anyone else's rights, including intellectual property rights
                  (e.g. copyright infringement, trademark infringement, forgery
                  or unlawful reproduction).
                </li>
                <li className={style.text}>
                  You may use the rights of someone else under the applicable
                  laws, with the exception or limitation of copyright and
                  related rights. Represents the ownership of all content you
                  post or share, or the acquisition of all necessary rights to
                  it including how to report any content that you think
                  infringes your intellectual property rights.
                </li>
                <li className={style.text}>
                  You may not modify, translate, create or reverse our products
                  or their components.
                </li>
                <li className={style.text}>
                  You may not use a domain name or URL in your username without
                  our prior written consent.
                </li>
              </ul>
              <h5 className={style.heading}>The permissions you give us : </h5>
              <div className={style.text}>
                As part of your agreement, you also give us the permissions we
                need to provide the services. We do not claim ownership of your
                content, but you grant us permission to use it.
                <p className={style.text}>
                  There are no changes to your rights to your content. We do not
                  claim ownership of your content that you post on or through
                  the Service, and you are free to share your content with
                  anyone and whenever you want. However, we need some legal
                  permissions from you to provide the service (known as a
                  "license").
                </p>
                <p className={style.text}>
                ...
                <p className={style.text}>
                  ...
                  allow us to show you without any compensation.
                </p>
                <p className={style.text}>
                  For example, we might show that you liked a sponsored post
                  created by a brand that paid us to display their ads on
                  Qviple.
                </p>
                <p className={style.text}>
                  In the case of actions on other content and follow-up on other
                  accounts, actions on sponsored content and follow-up on
                  sponsored accounts, this can only be seen by people who are
                  allowed to view or follow that content.
                </p>
                <p className={style.text}>We also respect your ad settings.</p>
                <p className={style.text}>
                  You agree that we may download and install updates to the
                  Service on your device.
                </p>
              </div>
              <h5 className={style.heading}>Additional rights we reserve</h5>
              <p className={style.text}>
                If you choose a username or identical identifier for your
                account, we may change it if we deem it appropriate or necessary
                (for example, if it infringes one person's intellectual property
                or impersonates another user).
              </p>
              <p className={style.text}>
                If you use content that we have and include in our Services (for
                example, the content, images, designs, videos or sounds that you
                add to the content you create or share and we provide) But not
                yours) reserves all rights.
              </p>
              <p className={style.text}>
                You may use our intellectual property and trademarks or similar
                symbols only as expressly permitted by our brand guidelines or
                with our prior written permission.
              </p>
              <p className={style.text}>
                You must obtain written permission from us or under the Open
                Source License to modify, derive, or otherwise delete, or
                otherwise attempt to extract source code.
              </p>
              <h5 className={style.heading}>
                Deleting content and disabling account
              </h5>
              <p className={style.text}>
                We may remove any content or information that you share on the
                Service, in violation of these Terms of Use, our policies or if
                we are permitted to do so by law or if necessary. To protect our
                community or services, or if you create risk or legal contact
                for us, or these Terms of Use or our policies. In case of
                infringement, or if you repeatedly infringe the intellectual
                property rights of others or if we are permitted or required by
                law to do so, we will provide you with the entire Service or any
                part thereof (including disabling or disabling access to your
                Products and Company Products). Can immediately refuse or stop.
              </p>
              <p className={style.text}>
                We may do so if we deem it necessary to stop or change the
                Service, remove or block any content or information shared on
                our Services, or stop providing some or all of the Services in
                order to avoid or reduce the adverse effects of laws or
                regulations on us. When you request to delete content, the
                deletion process starts automatically within 30 days after your
                request.
              </p>
              <p className={style.text}>
                Deleting content can take up to 90 days after the deletion
                process begins. Once the deletion process is turned on for such
                content, the content may not be visible to other users, but
                remains subject to these Terms of Use and our data policy. Once
                the content is deleted, it may take up to 90 days for us to back
                it up and remove it from the emergency recovery systems.
              </p>
              <p style={{ textAlign: "left" }}>
                Content will not be deleted within 90 days from the start of the
                content deletion process in the following cases:
              </p>
              <ul>
                <li className={style.text}>
                  When your content has been used by others under this license
                  and they have not deleted it (in that case this license will
                  continue to apply until that content is deleted); Or
                </li>
                <li className={style.text}>
                  Due to the technical limitations of our system, it may not be
                  possible to delete within 90 days, in which case, we will
                  technically complete the deletion process as soon as possible;
                  Or
                </li>
                <li className={style.text}>
                  When deleting restricts our ability to:
                </li>
                <li className={style.text}>
                  Investigating or identifying illegal activities and violations
                  of our terms and policies (e.g., identifying or investigating
                  the misuse of our products or systems);
                </li>
                <li className={style.text}>
                  Protecting the safety and security of our products, systems
                  and users;
                </li>
                <li className={style.text}>
                  Complying with legal obligations, such as preserving evidence;
                  Or
                </li>
                <li className={style.text}>
                ...
                <li className={style.text}>
                  ...
                  necessary for the purpose for which it was retained (the exact
                  duration will vary from case to case).
                </li>
                <li className={style.text}>
                  If you disable your account or we disable it, these terms as
                  an agreement between you and us are terminated, but this
                  section and the following "Your Agreement and What Happens If
                  We Disagree" section terminates, even if your account is
                  terminated, disabled or deleted Will apply.
                </li>
              </ul>
              ...
              <p className={style.text}>
                ...
                <span>Qviple</span>'s sole discretion, without prior notice to
                you. You may stop using the Service at any time. You do not need
                to specifically inform <span>Qviple</span> when you stop using
                the Service. You acknowledge and agree that if{" "}
                <span>Qviple</span> disables access to your account, you may be
              ...
              <h5 className={style.heading}>Modifications to Our app</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Updates to Our app</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                functionalities of the app. You agree that Qviple has no
              ...
              <p className={style.text}>
                ...
                constitute an integral part of the app, and (ii) subject to the
              ...
              <h5 className={style.heading}>Term and Termination</h5>
              <p className={style.text}>
                This Agreement shall remain in effect until terminated by you or
                Qviple.
              </p>
              <p className={style.text}>
                Qviple may, in its sole discretion, at any time and for any or
              ...
              <p className={style.text}>
                ...
                from Qviple, in the event that you fail to comply with any
                provision of this Agreement. You may also terminate this
                Agreement by deleting the app and all copies thereof from your
                computer.
              </p>
              <p className={style.text}>
                Upon termination of this Agreement, you shall cease all use of
                the app and delete all copies of the app from your computer.
              </p>
              <p className={style.text}>
                Termination of this Agreement will not limit any of Qviple's
              ...
              <h5 className={style.heading}>Copyright Infringement Notice</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Indemnification</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>No Warranties</h5>
              <p className={style.text}>
                ...
                practice. Without limitation to the foregoing, Qviple provides
              ...
              <p className={style.text}>
                ...
                on behalf of Qviple are free of viruses, scripts, trojan horses,
              ...
              <h5 className={style.heading}>Limitation of Liability</h5>
              <p className={style.text}>
                Notwithstanding any damages that you might incur, the entire
                liability of Qviple and any of its suppliers under any provision
              ...
              <p className={style.text}>
                ...
                shall Qviple or its suppliers be liable for any special,
                ...
                any way related to the use of or inability to use the app,
                third-party software and/or third-party hardware used with the
                app, or otherwise in connection with any provision of this
                Agreement), even if Qviple or any supplier has been advised of
              ...
              <h5 className={style.heading}>Severability</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                term or any other term, and Qviple's failure to assert any right
                or provision under this Agreement shall not constitute a waiver
                of such right or provision.
                <br /> YOU AND Qviple AGREE THAT ANY CAUSE OF ACTION ARISING OUT
              ...
              <h5 className={style.heading}>Waiver</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                o failure to exercise, and no delay in exercising, on the part
              ...
              <h5 className={style.heading}>Amendments to this Agreement</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                By continuing to access or use our app after any revisions
                become effective, you agree to be bound by the revised terms. If
                you do not agree to the new terms, you are no longer authorized
                to use Qviple.
              </p>

              <h5 className={style.heading}>Entire Agreement</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                when you use or purchase other Qviple's services, which Qviple
                will provide to you at the time of such use or purchase.
              </p>
              <h5 className={style.heading}>Updates to Our Terms</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Intellectual Property</h5>
              <p className={style.text}>
                The app and its entire contents, features and functionality
                (including but not limited to all information, software, text,
                displays, images, video and audio, and the design, selection and
                arrangement thereof), are owned by Qviple, its licensors or
                ...
                prior written permission of Qviple, unless and except as is
                expressly provided in these Terms &amp; Conditions. Any
                unauthorized use of the material is prohibited.
              </p>

              <h5 className={style.heading}>Agreement to Arbitrate</h5>
              <p className={style.text}>
                ...
                dispute, action, or other controversy between you and Qviple
              ...
              <h5 className={style.heading}>Notice of Dispute</h5>
              <p className={style.text}>
                ...
                and Qviple will attempt to resolve any dispute through informal
                negotiation within sixty (60) days from the date the Notice of
                Dispute is sent. After sixty (60) days, you or Qviple may
                commence arbitration.
              </p>

              <h5 className={style.heading}>Binding Arbitration</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Submissions and Privacy</h5>
              <p className={style.text}>
                ...
                whatsoever. Qviple and its affiliates shall have no obligations
              ...
              <h5 className={style.heading}>Promotions</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Typographical Errors</h5>
              <p className={style.text}>
              ...
              <h5 className={style.heading}>Miscellaneous</h5>
              <p className={style.text}>
                ...
                Qviple. Qviple will be entitled to injunctive or other equitable
                relief (without the obligations of posting any bond or surety)
                in the event of any breach or anticipatory breach by you. Qviple
                operates and controls the Qviple Service from its offices in IN.
                ...
                Accordingly, those persons who choose to access the Qviple
                Service from other locations do so on their own initiative and
                ...
                prior understandings, between you and Qviple concerning its
              ...
              <h5 className={style.heading}>Disclaimer</h5>
              <p className={style.text}>
              ...
              <p className={style.text}>
                ...
                Qviple exercises no editorial control over such content and
                makes no warranty or representation as to the accuracy,
                reliability or currency of any information, content, service or
                merchandise provided through or accessible via the Qviple
                Service. Without limiting the foregoing, Qviple specifically
                disclaims all warranties and representations in any content
                transmitted on or in connection with the Qviple Service or on
                sites that may appear as links on the Qviple Service, or in the
                products provided as a part of, or otherwise in connection with,
                the Qviple Service, including without limitation any warranties
                ...
                change without notice. Without limiting the foregoing, Qviple
                does not warrant that the Qviple Service will be uninterrupted,
              ...
              <div>
                ...
                >
                  ...
                  <br />
                  <span className={style.textHeading}>Email - </span>
                  <span>
                    <a
                ...
                >
                  ...
                  <span>
                    Near Ashoka Construction Udyog Bhavan Sinnar, Nashik
                    Maharashtra - 422103
                  </span>
                </section>
                <section className={style.text}>
                  <span className={style.textHeading}>Contact Number - </span>
                  <span>+91 7276147751</span>
                </section>
              </div>
            </div>
